...
router.route('/login')
  ...
  /*  res.render('dashboard',{
     ...
     */
         //res.json({ items: items, username_auth:req.user.username, email_auth:req.user.email});
        res.render('dashboard', { items: items, username_auth:req.user.username, email_auth:req.user.email});
      }
    });
    ...
    console.log("image_status:",req.body.image_status);
